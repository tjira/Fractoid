...
int main(int argc, char *argv[]) {
	...
	program.add_argument("-b", "--bailout").help("bailout radius").default_value(100).action([](const std::string &value) { return std::stoi(value); });
	program.add_argument("-f", "--fill").help("fill color").action([](const std::string& value) { return (unsigned char) std::stoi(value); }).nargs(3);
	program.add_argument("-i", "--iters").help("maximum number of iterations before bailout").default_value(100).action([](const std::string &value) { return std::stoi(value); });
	...
	program.add_argument("--solid").help("solid algorithm").action([](const std::string& value) { return (unsigned char) std::stoi(value); }).nargs(3);
	program.add_argument("--orbitrap").help("orbitrap algorithm").action([](const std::string &value) { return std::stoi(value); });
	program.add_argument("--density").help("density algorithm").action([](const std::string &value) { return std::stoi(value); });
	program.add_argument("--samples").help("number of samples for density algorithm").default_value(100000).action([](const std::string &value) { return std::stoi(value); });
